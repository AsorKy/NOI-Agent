...
def es_ragflow_database_list():
    # Validación mínima
    if not all([CONTAINER, ES_NAME, ES_USER, ES_PASS]):
        raise ValueError("⚠️ Faltan variables de entorno requeridas para la conexión ElasticSearch.")
